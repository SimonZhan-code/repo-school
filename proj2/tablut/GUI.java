...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuButton("Option->Auto black", this::auto);
        addMenuButton("Option->Auto white", this::auto);
        addMenuButton("Option->Manual black", this::manual);
        addMenuButton("Option->Manual white", this::manual);
        addMenuButton("Help->About", (s) -> displayText("About", ABOUT_TEXT));
        addMenuButton("Help->Tablut", (s) ->
    ...
    /** Response to "Restart" button clik.
     * @param dummy String passed in.*/
    ...
    private void manual(String dummy) {
        String temp = dummy.split(" ")[1];
        _pendingCommands.offer("manual " + temp);
    }

    /** Response to "auto black" button.
     * @param cmd String*/
    private void auto(String cmd) {
        String temp = cmd.split(" ")[1];
        _pendingCommands.offer("auto " + temp);
    }

    /** Response to "undo" button.
     * @param dummy  String*/
