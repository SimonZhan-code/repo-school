...
final class Square {
    ...
    /**
     * Return the Square with index INDEX. I have changed this method.
     */
    ...
    /**
     * Function to return all corners spaces.
     *
     * @return returning all the corners.
     */
    static Square[] corners() {
    ...
    /**
     * Function calculate the distance between.
     *
     * @param sq Square passed in to calculate distance.
     * @return return integer.
     */
    double distancebetween(Square sq) {
        double temp = 0.0;
        int row = this.row() - sq.row();
        int col = this.col() - sq.col();
        temp = Math.sqrt(Math.pow(row, 2) + Math.pow(col, 2));
        return temp;
    }

    /**
     * Set state of my clicking.
     */
    void setSelected() {
        selected = !selected;
    }
